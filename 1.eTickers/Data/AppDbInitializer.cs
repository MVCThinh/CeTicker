...
namespace _1.eTickers.Data
{
    public class AppDbInitializer
    {
        ...
        public static async Task SeedUsersAndRoleAsync(IApplicationBuilder app)
        {
            using (var serviceScope = app.ApplicationServices.CreateScope())
            {
                ...
                string adminUserEmail = "admin@rorze.com";
                ...
                if(adminUser == null)
                {
                    ...
                    await userManager.CreateAsync(newAdminUser, "Coding@1234?"); // Create Email and Password
                    await userManager.AddToRoleAsync(newAdminUser, UserRoles.Admin);
                }

                string appUserEmail = "user@rorze.com";

                var appUser = await userManager.FindByEmailAsync(appUserEmail);
                
                if (appUser == null)
                {
                    var newUserEmail = new ApplicationUser()
                    {
                    ...
                    await userManager.CreateAsync(newUserEmail, "Coding@1234?");
                    await userManager.AddToRoleAsync(newUserEmail, UserRoles.User);
                }
